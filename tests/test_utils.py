...
class TestCreateAgent:
    ...
    def test_create_agent_basic(
        ...
        result = create_agent(
            model_name="gpt-4", tools=sample_tools, api_key="test_key"
        )
        ...
        mock_planner_class.assert_called_once_with(
            mock_conversation, {"add": sample_tools[0]}, verbose=True
        )
    ...
    @patch("agentbuilder.utils.AgenticPlanner")
    @patch("agentbuilder.utils.AgenticLoop")
    def test_create_agent_verbose_false(
        self, mock_loop_class, mock_planner_class, mock_conversation_class, sample_tools
    ):
        ...
        create_agent(
            model_name="gpt-4", tools=sample_tools, api_key="test_key", verbose=False
        )
    ...
    @patch("agentbuilder.utils.AgenticPlanner")
    @patch("agentbuilder.utils.AgenticLoop")
    def test_create_agent_custom_max_iterations(
        self, mock_loop_class, mock_planner_class, mock_conversation_class, sample_tools
    ):
    ...
    @patch("agentbuilder.utils.AgenticPlanner")
    @patch("agentbuilder.utils.AgenticLoop")
    def test_create_agent_multiple_tools(
        self, mock_loop_class, mock_planner_class, mock_conversation_class, sample_tool
    ):
        ...
        create_agent(model_name="gpt-4", tools=tools, api_key="test_key")
    ...
    @patch("agentbuilder.utils.AgenticPlanner")
    @patch("agentbuilder.utils.AgenticLoop")
    def test_create_agent_no_api_key(
        self, mock_loop_class, mock_planner_class, mock_conversation_class, sample_tools
    ):
        ...
        create_agent(model_name="gpt-4", tools=sample_tools)
    ...
    @patch("agentbuilder.utils.AgenticPlanner")
    @patch("agentbuilder.utils.AgenticLoop")
    def test_create_agent_returns_agentic_loop(
        self, mock_loop_class, mock_planner_class, mock_conversation_class, sample_tools
    ):
