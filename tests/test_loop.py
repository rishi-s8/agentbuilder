...
from agentbuilder.Action.base import (AssistantMessageAction, CompleteAction,
                                      ...
                                      MakeLLMRequestAction, UserMessageAction)
...
class TestAgenticLoop:
    ...
    def test_run_simple_completion(
        self, agentic_loop, mock_conversation_wrapper, mock_planner
    ):
    ...
    def test_run_max_iterations(
        self, agentic_loop, mock_conversation_wrapper, mock_planner, capsys
    ):
    ...
    def test_run_max_iterations_verbose(
        self, mock_conversation_wrapper, mock_planner, sample_tool_map, capsys
    ):
    ...
    def test_run_multi_step_conversation(
        self, mock_conversation_wrapper, mock_planner, sample_tool_map
    ):
        ...
        complete_action = CompleteAction(
            content="Final answer", iterations=3, verbose=False
        )
    ...
    def test_run_with_tool_execution_flow(
        ...
        planner = AgenticPlanner(
            mock_conversation_wrapper, sample_tool_map, verbose=False
        )
    ...
    def test_run_handles_none_return(
        self, agentic_loop, mock_conversation_wrapper, mock_planner
    ):
    ...
    def test_run_preserves_conversation_history(
        self, mock_conversation_wrapper, mock_planner, sample_tool_map
    ):
