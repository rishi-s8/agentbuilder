...
class TestExecuteToolsAction:
    ...
    def test_execute_single_tool_dict_format(self, sample_tool_map, mock_conversation_wrapper):
    ...
    def test_execute_single_tool_object_format(self, sample_tool_map, mock_conversation_wrapper):
    ...
    def test_execute_tools_verbose(self, sample_tool_map, mock_conversation_wrapper, capsys):
...
class TestMakeLLMRequestAction:
    ...
    def test_make_llm_request_without_tools(self, mock_conversation_wrapper):
        ...
        mock_conversation_wrapper.client.chat.completions.create.return_value = mock_response
    ...
    def test_make_llm_request_with_tools(self, mock_conversation_wrapper, sample_tool_map):
        ...
        call_kwargs = mock_conversation_wrapper.client.chat.completions.create.call_args[1]
        assert "tools" in call_kwargs
        assert call_kwargs["tools"] is not None
        assert call_kwargs["tool_choice"] == "auto"
    
    def test_make_llm_request_with_tool_calls_response(self, mock_conversation_wrapper, sample_tool_map):
        """Test handling LLM response with tool calls."""
        mock_tool_call = Mock()
        mock_tool_call.model_dump.return_value = {"id": "call_1", "function": {"name": "add"}}
