...
from agentbuilder.Action.base import (AssistantMessageAction,
...
class TestConversationWrapper:
    ...
    def test_init_with_api_key(self, mock_openai):
        ...
        wrapper = ConversationWrapper(
            api_key="test_key", model="gpt-4", base_url="https://api.openai.com/v1"
        )
    ...
    def test_init_from_env(self, mock_load_dotenv, mock_openai):
        ...
        mock_openai.assert_called_once_with(
            api_key="env_key", base_url="https://test.com"
        )
    ...
    def test_verbose_mode(self, mock_openai):
        """Test verbose mode."""
        wrapper = ConversationWrapper(api_key="test_key", model="gpt-4", verbose=True)
