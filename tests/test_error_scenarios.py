...
class TestToolExecutionErrors:
    ...
    def test_tool_execution_with_invalid_json_arguments(self, mock_conversation_wrapper):
...
class TestLoopErrorRecovery:
    ...
    def test_loop_max_iterations_with_failing_tool(self, mock_conversation_wrapper, sample_tool_map):
